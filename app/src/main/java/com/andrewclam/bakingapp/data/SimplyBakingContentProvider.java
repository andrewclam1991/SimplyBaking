...
public class SimplyBakingContentProvider extends ContentProvider {
    ...
    private static final String TAG = SimplyBakingContentProvider.class.getName();
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // Add URI matches
        uriMatcher.addURI(SimplyBakingDbContract.AUTHORITY, SimplyBakingDbContract.PATH_RECIPES, PLANTS);
        uriMatcher.addURI(SimplyBakingDbContract.AUTHORITY, SimplyBakingDbContract.PATH_RECIPES + "/#", PLANT_WITH_ID);
        return uriMatcher;
    }

    // Member variable for a SimplyBakingDbHelper that's initialized in the onCreate() method
    private SimplyBakingDbHelper mSimplyBakingDbHelper;

    @Override
    public boolean onCreate() {
        Context context = getContext();
        mSimplyBakingDbHelper = new SimplyBakingDbHelper(context);
        return true;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        final SQLiteDatabase db = mSimplyBakingDbHelper.getWritableDatabase();
        ...
        switch (match) {
            case PLANTS:
                ...
                if (id > 0) {
                    returnUri = ContentUris.withAppendedId(SimplyBakingDbContract.RecipeEntry.CONTENT_URI, id);
                } else {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        final SQLiteDatabase db = mSimplyBakingDbHelper.getReadableDatabase();
